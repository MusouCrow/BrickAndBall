...
namespace Game.Component.Brick_.States {
	using Component;
	using Utility;

	[CreateAssetMenuAttribute(menuName="Game/State/Elast")]
	public class Elast : State.Data {
		[SerializeField]
	...
	public class ElastState : State {
		private Elast data;
		private Brick brick;

		public ElastState(GameObject gameObject, Elast data) : base(gameObject, data) {
			this.data = data;
